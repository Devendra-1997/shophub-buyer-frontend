    ...
    <div className="text-gray-700 dark:text-gray-300 text-sm">
      <div className="mx-auto max-w-5xl px-10 py-10">
        ...
        <section className="mb-10">
          <h2 className="text-base font-semibold mb-3">Visit Our Showroom</h2>
          <p className="mb-4">
            Luxury Car Showroom <br />
            Mon-Sat 9:00 AM - 6:00 PM <br />
            123 Prestige Drive <br />
            Central Business District <br />
            Melbourne, VIC 3000
          </p>
        </section>
        <section className="mb-10">
          <h2 className="text-base font-semibold mb-3">Call Our Team</h2>
          <p className="mb-4">
            (03) 1234 5678 <br />
        ...
        <section className="mb-10">
          ...
          <p className="mb-4">
            For any inquiries, feel free to reach out via the form below or
        ...
        <section className="mb-10">
          ...
          <form className="space-y-6 text-sm" onSubmit={handleOnSubmit}>
            ...
            <button
              type="submit"
              className="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-teal-700"
            >
              Send Message
            </button>
          </form>
        ...
        <section>
          <p>1300 294 328 - Official contact number for LuxCars.</p>
        </section>
      </div>
    </div>
  );
